                            ...
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-id-card"></i></span> CI: ${usuario.dni}</li>
                                        ...
                                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-smile-wink"></i></span> Genero: ${usuario.sexo}</li>       
                                    </ul>
                                </div>
